...
numOfWordsAndPopularity.py
    -Creates a graph, that using a dataset of comments, that displays all comments (in ranges) and their
     average popularity scores (excluding connector words i.e.,words that are less than 2 characters)
...
timeOfCreationAndScore.py
    ...
    creation date) and the average score the comments received.

dayTimeOfCreationAndScore.py
    -Creates a graph, that using a dataset of comments, displays the posts from a given hour (based on their
    creation date) and the average score the comments received.
